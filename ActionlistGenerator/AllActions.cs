...
namespace ActionlistGenerator
{
    ...
    {
        public static Action callRfc = new Action("callRFC", "Führt eine RFC-Anfrage durch", new XElement("callRfc",
        ...
        public static Action callWebservice = new Action("callWebService", "Führt eine HTTP-Anfrage durch.", new XElement("callWebService",
            new XElement("url", ""),
        ...
        public static Action choose = new Action("choose", "Quasi eine if-Abfrage.", new XElement("choose",
            new XElement("when", 
        ...
        public static Action cleanupEpim = new Action("cleanupEPIM", "Löscht diverse Datenbankeinträge der EPIM Datenbank.", new XElement("cleanupEPIM",
            new XAttribute("type", "csvExport"),
            new XAttribute("id", "00000")
        ));
        public static Action config = new Action("config", "Liest Variablen aus/schreibt Variablen in Konfig-Dateien.", new XElement("config",
        ...
        public static Action convert = new Action("convert", "Konvertiert Dateien zwischen verschiedenen Formaten, z.B. XML<>JSON.", new XElement("convert",
        ...
        public static Action copy = new Action("copy", "Kopiert Dateien und Ordner.", new XElement("copy",
        ...
        public static Action createHash = new Action("createHash", "Generiert die Prüfsumme einer Property/Datei.", new XElement("createHash",
        ...
        public static Action createList = new Action("createList", "Erstellt eine Dateiliste.", new XElement("createList",
        ...
        public static Action delete = new Action("delete", "löscht Dateien und Verzeichnisse.", new XElement("delete",
        ...
        public static Action echo = new Action("echo", "Schreibt Text ins Log oder in eine Datei.", new XElement("echo",
        ...
        public static Action email = new Action("email", "Versendet eine E-mail.", new XElement("email",
        ...
        public static Action executeShell = new Action("executeShell", "Führt einen Shell-/Systembefehl aus.", new XElement("executeShell",
        ...
        public static Action executeSQL = new Action("executeSQL", "Führt eine SQL-Query durch.", new XElement("executeSQL",
            
            new XElement("outputFile", ""),
            new XElement("outputProperty", ""),
            new XElement("sql", "")
        ));        
        public static Action executeXQuery = new Action("executeXQuery", "Führt Anfragen in einer XML-Datenbank aus.", new XElement("executeXQuery",
        ...
        public static Action exit = new Action("exit", "beendet die Actionlist ohne Fehler.", new XElement("exit",
            new XAttribute("message", "A relevant exit message")
        ));
        public static Action fail = new Action("fail", "Bricht die Actionlist mit einer Fehlermeldung ab.", new XElement("fail",
            new XAttribute("message", "some error message")
        ));
        public static Action fop = new Action("fop", "Erstellt PDF-Dateien mittels Apache FOP aus einer FO-Datei.", new XElement("fop",
        ...
        public static Action forEachItemListXml = new Action("forEachItemListXml", "Iteriert über eine Itemlist.", new XElement("forEachItemListXml",
            new XAttribute("file", "${sessionWorkDir}/products.itemlist.xml"),
            new XAttribute("ignoreErrorsInIteration", "false")
        ));
        public static Action forEachKeyValueList = new Action("forEachKeyValueList", "Iteriert über Werte einer Schlüssel-Wert-Liste.", new XElement("forEachKeyValueList",
            new XAttribute("file", "${sessionWorkDir}/products.itemlist.xml"),
            new XAttribute("ignoreErrorsInIteration", "false")
        ));
        public static Action forEachList = new Action("forEachList", "Iteriert anhand eines Trennzeichens über eine Liste von Elementen.", new XElement("forEachList",
            new XAttribute("list", "value1;value2;value3"),
            new XAttribute("delimier", ";"),
            new XAttribute("ignoreErrorsInIteration", "false"),
            new XAttribute("propertyName", "listProperty")
        ));
        public static Action getDataFromSap = new Action("getDataFromSap", "Importiert Produkte von SAP zu EPIM.", new XElement("getDataFromSap",
        ...
        public static Action milestone = new Action("milestone", "Speichert den Status eines Prozess, sodass er später fortgeführt werden kann.", new XElement("milestone", 
            new XAttribute("name", "name of the milstone")
        ));
        public static Action mkDir = new Action("mkDir", "Erstellt ein Verzeichnis, ggfs. rekursiv.", new XElement("mkDir",
            new XAttribute("dir", "${sessionWorkDir}/generated-files")
        ));
        public static Action move = new Action("move", "Verschiebt Dateien.", new XElement("move",
        ...
        public static Action property = new Action("property", "Deklariert/setzt eine Variable.", new XElement("move",
        ...
        public static Action rename = new Action("rename", "Benennt Dateien und Verzeichniss um.", new XElement("rename",
            new XElement("sourcePath", "${workDir}/important-file.xml"),
            new XElement("targetName", "newname.xml")
        ));
        public static Action searchAndReplace = new Action("searchReplace", "Ersetzt Daten in Dateien.", new XElement("searchandreplace",
        ...
        public static Action setOrderBack = new Action("setOrderBack", "Setzt eine JobScheduler Order zurück.", new XElement("setOrderBack"));
        public static Action setOrderState = new Action("setOrderState", "Setzen den Status der Order.", new XElement("setOrderState",
            new XAttribute("value", "200")
        ));
        public static Action sleep = new Action("sleep", "Blockiert die Ausführung für die angegebene Zeitdauer.", new XElement("sleep",
            new XAttribute("hours", "0"),
            new XAttribute("minutes", "0"),
            new XAttribute("seconds", "0"),
            new XAttribute("milliseconds", "0")
        ));
        public static Action touch = new Action("touch", "Erstellt eine leere Datei", new XElement("touch",
            new XAttribute("file", "${exportDir}/export.xml")
        ));
        public static Action transform = new Action("transform", "Führt eine XSL-Transformation durch.", new XElement("transform",
        ...
        public static Action unzip = new Action("unzip", "Entpackt eine Zip-Datei.", new XElement("unzip",
        ...
        public static Action validateXml = new Action("validateXML", "Validiert eine XML-Datei gegen ein XSD-Schema.", new XElement("validateXML",
        ...
        public static Action zip = new Action("zip", "Erstellt eine Zip-Datei aus Dateien und Verzeichnissen.", new XElement("zip",
            new XAttribute("ignoreNoFilesFound", "false"),
